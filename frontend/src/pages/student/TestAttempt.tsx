...
export default function StudentTestAttempt() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Navbar */}
      <nav className={`sticky top-0 z-30 border-b border-border backdrop-blur-md transition-colors ${isDanger ? 'bg-red-950/90 border-red-800/50' :
        ...
        <div className="flex items-center h-12 px-4 gap-3">
          ...
          <div className="ml-auto flex items-center gap-3">
            <div className={`flex items-center gap-1.5 px-3 py-1 rounded-lg font-mono text-sm font-bold ${isDanger ? 'bg-red-500/20 text-red-300' :
